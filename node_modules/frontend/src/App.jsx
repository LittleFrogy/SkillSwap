    ...
    <nav className="bg-white border-b border-slate-200 px-8 py-0 flex items-center justify-between sticky top-0 z-40">
      <div className="flex items-center gap-10">
        ...
        <div className="flex gap-8 h-full">
          ...
          <Link to="/dashboard" className={`font-medium py-5 border-b-2 ${isActive('/dashboard') ? 'text-blue-600 border-blue-600' : 'text-slate-500 border-transparent hover:text-slate-900'}`}>Endorse partner</Link>
          <Link to="/endorsements" className={`font-medium py-5 border-b-2 ${isActive('/endorsements') ? 'text-blue-600 border-blue-600' : 'text-slate-500 border-transparent hover:text-slate-900'}`}>Endorsements</Link>
        </div>
      </div>
